...
namespace KickStart
{
    ...
    public sealed class LogBuilder
    {
        ...
        /// </summary>
        /// <param name="traceLevel">The starting trace level.</param>
        /// <param name="writer">The delegate to write logs to.</param>
        public LogBuilder(TraceLevel traceLevel, Action<LogData> writer)
        {
            _writer = writer ?? Logger.TraceWrite;
            _data = new LogData
            {
        ...
        /// <returns></returns>
        public LogBuilder Level(TraceLevel logLevel)
        {
            _data.TraceLevel = logLevel;
            return this;
        }
