...
internal sealed partial class ThisAssembly {
    ...
    internal const string AssemblyVersion = "6.2.0.0";
    
    internal const string AssemblyFileVersion = "6.2.0.0";
    
    internal const string AssemblyInformationalVersion = "6.2.0.0";
