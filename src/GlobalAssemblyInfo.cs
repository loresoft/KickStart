...
internal sealed partial class ThisAssembly {
    ...
    internal const string AssemblyVersion = "4.1.0.0";
    
    internal const string AssemblyFileVersion = "4.1.0.0";
    
    internal const string AssemblyInformationalVersion = "4.1.0.0";
